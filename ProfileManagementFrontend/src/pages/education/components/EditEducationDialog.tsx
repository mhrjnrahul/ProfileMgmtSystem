...
type UpdateEducationFormData = z.infer<typeof updateEducationSchema>;

export default function EditEducationDialog({ education }: Props) {
  ...
  const mutation = useMutation({
    mutationFn: (data: UpdateEducationFormData & { id: number }) =>
  ...
  const onSubmit = async (data: UpdateEducationFormData) => {
