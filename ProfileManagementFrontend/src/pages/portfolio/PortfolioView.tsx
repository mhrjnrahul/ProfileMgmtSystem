  ...
  return (
    ...
    >
      ...
      <div className="bento-grid">
        ...
        {/* Hero Card */}
        <div
          className={`bento-card ${hasSkills ? "col-span-2" : "col-span-3"}`}
          style={{ padding: "32px" }}
        >
          <div style={{ display: "flex", alignItems: "flex-start", gap: 20 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p style={{ fontSize: 13, color: "#B8B0A8", marginBottom: 8 }}>
                {profile.email}
              </p>
              {(profile.city || profile.country) && (
                ...
                >
                  <HiLocationMarker
                    style={{ width: 11, height: 11, color: "#C4A882" }}
                  />
        ...
        {hasSkills && (
          <div className="bento-card" style={{ padding: "24px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {skills
                ?.slice(0, showAllSkills ? skills.length : 6)
        ...
        {(hasWork || hasEdu) && (
          <div
            ...
            style={{
              display: "grid",
              gridTemplateColumns: hasWork && hasEdu ? "1fr 1fr" : "1fr",
              gap: 14,
            }}
          >
            {hasWork && (
        ...
        {hasProjects && (
          <div
            className={`bento-card ${hasSocial ? "col-span-2" : "col-span-3"}`}
